...
import { getStateKPIs, getStateRiskDistribution, getCommissionerAlerts, getEscalationSummary } from '../services/dashboardService';
import { getAllDistrictsSummary } from '../services/districtService';
...
const ExecutiveDashboard: React.FC = () => {
  ...
  const { data: kpis, loading: kpisLoading } = useSupabaseQuery(() => getStateKPIs(), []);
  const { data: riskDist, loading: riskLoading } = useSupabaseQuery(() => getStateRiskDistribution(), []);
  const { data: districts, loading: districtsLoading } = useSupabaseQuery(() => getAllDistrictsSummary(), []);
  const { data: alerts } = useSupabaseQuery(() => getCommissionerAlerts(5), []);
  const { data: escalation } = useSupabaseQuery(() => getEscalationSummary(), []);
  ...
  // Trend data — placeholder until historical data is available
  const trendData = [
    { name: 'Q1-22', value: 120000, target: 150000 },
    { name: 'Q2-22', value: 145000, target: 150000 },
    { name: 'Q3-22', value: 180000, target: 200000 },
    { name: 'Q4-22', value: 210000, target: 200000 },
    { name: 'Q1-23', value: 250000, target: 250000 },
    { name: 'Q2-23', value: 285000, target: 300000 },
    { name: 'Q3-23', value: 310000, target: 300000 },
    { name: 'Q4-23', value: kpis?.screened || 342000, target: 350000 },
  ];
