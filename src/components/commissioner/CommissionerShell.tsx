...
export default function CommissionerShell({ children, userName, userEmail, avatarUrl }: CommissionerShellProps) {
        ...
        <div className="min-h-screen bg-[#F9F9F9] selection:bg-black selection:text-white">
            ...
            <nav className="fixed top-0 left-0 right-0 h-[56px] bg-black flex items-center justify-between px-6 z-50">
                <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2 cursor-pointer" onClick={() => handleNavigation(AppView.DASHBOARD)}>
